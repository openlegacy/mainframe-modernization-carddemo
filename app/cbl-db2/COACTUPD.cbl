      ...
      *           PERFORM SEND-LONG-TEXT
       ...
       9400-GETCUSTDATA-BYCUST.
           MOVE WS-CARD-RID-CUST-ID TO HV-CUSTOMER-ID
           ...
           EVALUATE SQLCODE
               WHEN 0
                  SET FOUND-CUST-IN-MASTER        TO TRUE
                  SET FOUND-ACCT-IN-MASTER        TO TRUE
      *           Move all fields to CUSTOMER-RECORD structure
      ...
      *    Read the account file for update
           ...
           MOVE CC-ACCT-ID              TO HV-ACCOUNT-ID
      ...
      *    Read the customer file for update
           ...
           MOVE CDEMO-CUST-ID                   TO HV-CUSTOMER-ID
      ...
      *****************************************************************
           ...
           MOVE ACCT-UPDATE-ID                  TO HV-ACCT-ID
           MOVE ACCT-UPDATE-ACTIVE-STATUS       TO HV-ACCT-STATUS
           MOVE ACCT-UPDATE-CURR-BAL            TO HV-ACCT-CURR-BAL
           MOVE ACCT-UPDATE-CREDIT-LIMIT        TO HV-ACCT-CREDIT-LMT
           MOVE ACCT-UPDATE-CASH-CREDIT-LIMIT   TO HV-ACCT-CASH-LMT
           MOVE ACCT-UPDATE-OPEN-DATE           TO HV-ACCT-OPEN-DT
           MOVE ACCT-UPDATE-EXPIRAION-DATE      TO HV-ACCT-EXPIRY-DT
           MOVE ACCT-UPDATE-REISSUE-DATE        TO HV-ACCT-REISSUE-DT
           MOVE ACCT-UPDATE-CURR-CYC-CREDIT     TO HV-ACCT-CYC-CREDIT
           MOVE ACCT-UPDATE-CURR-CYC-DEBIT      TO HV-ACCT-CYC-DEBIT
      ...
      * Update customer *
      *****************************************************************
           MOVE CUST-UPDATE-ID                  TO HV-CUST-ID
           MOVE CUST-UPDATE-FIRST-NAME          TO HV-CUST-FNAME
           MOVE CUST-UPDATE-MIDDLE-NAME         TO HV-CUST-MNAME
           MOVE CUST-UPDATE-LAST-NAME           TO HV-CUST-LNAME
           MOVE CUST-UPDATE-ADDR-LINE-1         TO HV-CUST-ADDR1
           MOVE CUST-UPDATE-ADDR-LINE-2         TO HV-CUST-ADDR2
           MOVE CUST-UPDATE-ADDR-LINE-3         TO HV-CUST-ADDR3
           MOVE CUST-UPDATE-ADDR-STATE-CD       TO HV-CUST-STATE
           MOVE CUST-UPDATE-ADDR-COUNTRY-CD     TO HV-CUST-COUNTRY
           MOVE CUST-UPDATE-ADDR-ZIP            TO HV-CUST-ZIP
           MOVE CUST-UPDATE-PHONE-NUM-1         TO HV-CUST-PHONE1
           MOVE CUST-UPDATE-PHONE-NUM-2         TO HV-CUST-PHONE2
           MOVE CUST-UPDATE-SSN                 TO HV-CUST-SSN
           MOVE CUST-UPDATE-GOVT-ISSUED-ID      TO HV-CUST-GOVT-ID
           MOVE CUST-UPDATE-DOB-YYYY-MM-DD      TO HV-CUST-DOB
           MOVE CUST-UPDATE-EFT-ACCOUNT-ID      TO HV-CUST-EFT-ID
           MOVE CUST-UPDATE-PRI-CARD-IND        TO HV-CUST-PRI-HOLDER
