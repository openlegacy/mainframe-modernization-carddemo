      ******************************************************************
      * Program     : COUSR03D.CBL
      * Application : CardDemo
      * Type        : CICS COBOL Program
      * Function    : Delete a user from USERSEC DB2 table
      ******************************************************************
      ...
      *----------------------------------------------------------------*
       ...
       01 WS-VARIABLES.
         05 WS-PGMNAME                 PIC X(08) VALUE 'COUSR03D'.
         05 WS-TRANID                  PIC X(04) VALUE 'ADS3'.
       ...
       READ-USER-SEC-TABLE.
           ...
           EVALUATE WS-SQL-STATUS
               ...
               WHEN +100
                   ...
                   PERFORM SEND-USRDEL-SCREEN
               WHEN OTHER
                   DISPLAY 'SQL ERROR - SQLCODE:' WS-SQL-STATUS
                   MOVE 'Y'     TO WS-ERR-FLG
