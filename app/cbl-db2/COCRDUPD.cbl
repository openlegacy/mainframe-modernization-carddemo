      ...
      *       Move data from host variables to CARD-RECORD structure
              ...
              MOVE HV-CARD-CVV-CD       TO CCUP-OLD-CVV-CD

              INSPECT HV-CARD-EMBOSSED-NAME
              CONVERTING LIT-LOWER
                      TO LIT-UPPER

              MOVE HV-CARD-EMBOSSED-NAME   TO CCUP-OLD-CRDNAME
              MOVE HV-CARD-EXPIRY-DATE(1:4)
                                        TO CCUP-OLD-EXPYEAR
              MOVE HV-CARD-EXPIRY-DATE(6:2)
                                        TO CCUP-OLD-EXPMON
              MOVE HV-CARD-EXPIRY-DATE(9:2)
                                        TO CCUP-OLD-EXPDAY
              MOVE HV-CARD-ACTIVE-STATUS   TO CCUP-OLD-CRDSTCD
      ...
      *
           MOVE CC-CARD-NUM             TO HV-CARD-NUM
           ...
           EVALUATE SQLCODE
               ...
               WHEN OTHER
                  ...
                  MOVE WS-DB2-ERROR-MESSAGE          TO WS-RETURN-MSG
           END-EVALUATE
           .
      ...
      *    Update the Card record directly using DB2
      *    (DB2 will handle locking automatically during update)
           MOVE CC-CARD-NUM             TO HV-CARD-NUM
      ...
      *    Move CARD-RECORD to host variables for update
           ...
           MOVE CCUP-OLD-EXPYEAR            TO WS-DATE-STRING(1:4)
           MOVE '-'                         TO WS-DATE-STRING(5:1)
           MOVE CCUP-OLD-EXPMON             TO WS-DATE-STRING(6:2)
           MOVE '-'                         TO WS-DATE-STRING(8:1)
           MOVE CCUP-OLD-EXPDAY             TO WS-DATE-STRING(9:2)
      ...
      *****************************************************************
           EXEC SQL
                ...
                WHERE  CARD_NUM = :HV-CARD-NUM
                AND    CARD_EMBOSSED_NAME = :CCUP-OLD-CRDNAME
                AND    CARD_EXPIRY_DATE = :WS-DATE-STRING
                AND    CARD_ACTIVE_STATUS = :CCUP-OLD-CRDSTCD
           END-EXEC
      ...
      *            Re-read the current data to show user
                   PERFORM 9000-READ-DATA
                      THRU 9000-READ-DATA-EXIT
      ...
      *    This paragraph is no longer needed with optimistic locking
