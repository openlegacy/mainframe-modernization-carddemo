*****************************************************************
      ...
      ******************************************************************
              WHEN CDEMO-PGM-ENTER
               AND CDEMO-FROM-PROGRAM  EQUAL LIT-CCLISTPGM
                   ...
                   MOVE CDEMO-ACCT-ID       TO CC-ACCT-ID
      ...
      *
           MOVE CC-CARD-NUM       TO HV-SEARCH-CARD-NUM
           ...
           EVALUATE WS-SQLCODE
               WHEN 0
                  ...
                  MOVE HV-CARD-EXPIRAION-DATE TO CARD-EXPIRAION-DATE
      ...
      *    Read the Card table by Account ID using DB2
      *
