      ...
      *----------------------------------------------------------------*
       PROCESS-ENTER-KEY.
           ...
           DISPLAY 'DEBUG: ENTERING PROCESS-ENTER-KEY'
           ...
           DISPLAY 'DEBUG: SELECTED OPTION = ' WS-OPTION
           ...
           IF NOT ERR-FLG-ON
               ...
               IF CDEMO-MENU-OPT-PGMNAME(WS-OPTION)(1:5) NOT = 'DUMMY'
                   ...
                   END-EXEC
               ELSE
                   DISPLAY 'DEBUG: DUMMY PROGRAM - SHOWING MESSAGE'
               END-IF
               MOVE SPACES             TO WS-MESSAGE
